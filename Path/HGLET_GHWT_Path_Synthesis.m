function [f,GS] = HGLET_GHWT_Path_Synthesis(dvec,GP,BS,trans,G)
...
% reconstruct the signal for a path graph
%
% Input
...
fH = HGLET_Path_Synthesis(dvecH,GP,BS,G);
fHrw = HGLET_Path_Synthesis(dvecHrw,GP,BS,G,1);
fHsym = HGLET_Path_Synthesis(dvecHsym,GP,BS,G,1,1);
