function GP = PartitionTreePathNCut(G)
% Generate a partition tree for a path graph using Ncut
%
% Input
%   G       a GraphSig object
%
...
% use NCut to recursively bipartition
while regioncount < N
    ...
    for r = 1:regioncount
        ...
        if rs(r,j) ~= rs(r+1,j)-1
            ...
            pm = PartitionPathNCut(W(indrs,indrs));
