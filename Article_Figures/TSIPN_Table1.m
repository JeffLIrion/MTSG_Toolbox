...
fprintf('                              Dendrite             Toronto\n');
fprintf('                             (%.2f dB)           (%.2f dB)\n\n',SNRs(1),SNRs(2));
fprintf('HGLET (L) Best Basis       %5.2f dB (t=%.1f)    %5.2f dB (t=%.1f)\n',results(1,1), tau1(1), results(1,2), tau1(2));
fprintf('Lap. Eigenvectors (L)      %5.2f dB            %5.2f dB\n',results(2,1), results(2,2));
fprintf('GHWT Best Basis            %5.2f dB (t=%.1f)    %5.2f dB (t=%.1f)\n',results(3,1), tau3(1), results(3,2), tau3(2));
fprintf('Haar                       %5.2f dB            %5.2f dB\n',results(4,1), results(4,2));
fprintf('Hybrid Best Basis          %5.2f dB (t=%.1f)    %5.2f dB (t=%.1f)\n',results(5,1), tau5(1), results(5,2), tau5(2));
fprintf('Walsh Basis                %5.2f dB            %5.2f dB\n',results(6,1), results(6,2));
fprintf('\n\n');