function fig = Display_GHWT_Basis_Vectors_f2c(G,GP)
% Display a figure of the GHWT basis vectors in their fine-to-coarse
% arrangement
%
% Input
%   G       a GraphSig object
...
%
% Output
%   fig     a figure of the GHWT basis vectors (fine-to-coarse dictionary)
%
%
%
...
for j = 1:jmax
    ...
    for row = 1:N
        ...
        s1 = subplot(jmax,N,N*(jmax-j)+IX(row));
        axis equal;
        axis off;
        if dim == 1
            axis([0.9, N+0.1, -1, 1]);
